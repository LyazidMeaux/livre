...
class Chap333 extends StatelessWidget {
  @override
...
class ThemeBLOC extends InheritedWidget {
  ...
  open(String theme) {
    ...
    ColorOptions newColorOptions = ColorOptions.fromJson(jsonDecode(themeAsJson));
    this._colorOptions = newColorOptions;
  }

  saveAs(String theme) {
    String themeAsJson = json.encode(_colorOptions.toJson());
